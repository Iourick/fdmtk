...
//            return false;
//        }
//        thrust::device_vector<Cand> d_vctCandHeap(d_parrCand, d_parrCand + quant_candidates);
//        cudaFree(d_parrCand);
//        
//       
//        
...
//        fnc_grouping(d_vctCandHeap, member_offset, d_pbin_metrics[0], d_vctIndeces, d_vctOffset);        
//       
//        // !6
//      
//        // 7. mdt-axis grouping 
//        member_offset = offsetof(Cand, mdt);
//        fnc_grouping(d_vctCandHeap, member_offset, d_pbin_metrics[1], d_vctIndeces, d_vctOffset);
//        // !7    
//
//        // 8. mwidth-axis grouping 
//        member_offset = offsetof(Cand, mwidth);
//        fnc_grouping(d_vctCandHeap, member_offset, d_pbin_metrics[2], d_vctIndeces, d_vctOffset);
//        // !8   
//
...
//            select_delegates::write_log(d_vctCandHeap,
//                d_vctOffset,
//                d_vctIndeces,
//                d_vctNumDelegates,
//                filename
...
)
{
   ...
   // }
    ...
    //----------------------------------------------------------------------------------------------------------------------------------------------
    __global__
        void clusterization::normalize_and_floor_fdmt_kernel(float* d_arr, float* d_norm, const int  LEngth)
    {
        ...
        d_arr[idx] = fdividef(floorf(fdividef(d_arr[idx] * 1000.0f, sqrtf(d_norm[idx] + 0.0000001))), 1000.0f);
    }
    //--------------------------------------------------------------------------
