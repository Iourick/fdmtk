#ifndef CLUSTERIZATION_CUH
#define CLUSTERIZATION_CUH
...
{
    __global__
   void normalize_and_floor_fdmt_kernel(float* d_arr, float* d_norm, const int  LEngth);
